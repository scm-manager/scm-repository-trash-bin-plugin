...
<h1 align="center">
  Repository Trash Bin
</h1>

Move repositories to trash bin instead of instant deletion

## Usage

Find out how this plugin works on the [plugin documentation page](https://scm-manager.org/plugins/scm-repository-trash-bin-plugin/docs/).
